...
void ABattleGameMode::BeginPlay()
{
	...
	// Launch with:  UnrealEditor.exe <uproject> <map>?game=/Script/Bieda_total_war.BattleGameMode -game -BiedaAutoTest
	// Spawns one squad in front of the default camera and adds lights (for
	// empty maps — skip this on maps that already have their own army/lights).
	// Screenshots + auto-quit live in the module hook (Bieda_total_war.cpp)
	// so they work on any map. Zero effect without the flag.
